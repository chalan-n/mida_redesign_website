...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name && $phone && $salary) {
        try {
            $sql = "INSERT INTO loan_applications (loan_type, name, phone, line_id, occupation, salary, loan_amount, created_at) VALUES ('personal_loan', ?, ?, ?, ?, ?, ?, NOW())";
            $stmt = $db->prepare($sql);
            $stmt->execute([$name, $phone, $line_id, $occupation, $salary, $loan_amount]);
...
<head>
    ...
    <title>สมัครสินเชื่อส่วนบุคคล - MIDA LEASING</title>
    <meta name="description" content="สมัครสินเชื่อส่วนบุคคลออนไลน์ อนุมัติไว ไม่ต้องมีคนค้ำ เชื่อถือได้">
...
<body>
    ...
    <div class="register-header">
        <div class="container">
            <h1 style="margin-bottom: 10px; color: var(--accent-gold);">สมัครสินเชื่อส่วนบุคคล</h1>
            <p style="opacity: 0.9;">เงินก้อนอนุมัติไว เพื่อทุกความต้องการ (ประเมินฟรี)</p>
        </div>
    </div>
        ...
        <div class="register-card">
            ...
            <form action="" method="POST">
                ...
                <h3
                    ...
                    <i class="fa-solid fa-briefcase"></i> ข้อมูลอาชีพและรายได้
                </h3>

                <div class="form-group">
                    <label class="form-label">อาชีพ <span style="color: red;">*</span></label>
                    <select name="occupation" class="form-control" required>
                        <option value="">-- เลือกอาชีพ --</option>
                        <option value="salary">พนักงานประจำ</option>
                ...
                <div class="form-group">
                    <label class="form-label">รายได้ต่อเดือน (บาท) <span style="color: red;">*</span></label>
                    <input type="number" name="salary" class="form-control" placeholder="ระบุรายได้เฉลี่ยต่อเดือน"
                        required>
                </div>
