...
<head>
    ...
    <meta name="description"
        content="บริการสินเชื่อเช่าซื้อรถยนต์ทุกประเภท ทั้งรถเก๋ง รถกระบะ และรถบรรทุกมือสอง ผ่อนสบาย เงื่อนไขไม่ยุ่งยาก ช่วยให้คุณเป็นเจ้าของรถในฝันได้ง่ายขึ้นกับ ไมด้า ลิสซิ่ง">
    <meta name="keywords"
        content="สินเชื่อเช่าซื้อรถยนต์, จัดไฟแนนซ์รถมือสอง, ผ่อนรถบรรทุก">
